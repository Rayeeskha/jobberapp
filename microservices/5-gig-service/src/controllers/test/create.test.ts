...
import { BadRequestError } from '@rayeeskha/jobber-shared';
import { Request, Response } from 'express';
import { gigCreate } from '@gig/controllers/create';
import * as helper from '@rayeeskha/jobber-shared';
...
jest.mock('@rayeeskha/jobber-shared');
jest.mock('@rayeeskha/jobber-shared');
...
describe('Gig Controller', () => {
  ...
  describe('gig method', () => {
    ...
    it('should throw file upload error', () => {
      ...
      const res: Response = gigMockResponse();
      jest
        .spyOn(gigCreateSchema, 'validate')
        .mockImplementation((): any => Promise.resolve({ error: {} }));
      jest
        .spyOn(helper, 'uploads')
