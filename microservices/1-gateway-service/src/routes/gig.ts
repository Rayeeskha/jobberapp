...
class GigRoutes {
  ...
  public routes(): Router {
    ...
    this.router.get(
      ...
      authMiddleware.checkAuthentication,
      Search.prototype.gigs,
    );
    this.router.get(
      '/gig/category/:username',
      authMiddleware.checkAuthentication,
      Get.prototype.getGigsByCategory,
    );
    this.router.get(
      '/gig/top/:username',
      authMiddleware.checkAuthentication,
      Get.prototype.getTopRatedGigsByCategory,
    );
    this.router.get(
      '/gig/similar/:gigId',
      authMiddleware.checkAuthentication,
      Get.prototype.getMoreGigsLikeThis,
    );
    this.router.post(
      '/gig/create',
      authMiddleware.checkAuthentication,
    ...
    this.router.put(
      '/gig/active/:gigId',
      authMiddleware.checkAuthentication,
      Update.prototype.gigActive,
    );
    this.router.put(
      '/gig/seed/:count',
      authMiddleware.checkAuthentication,
      GigSeed.prototype.gig,
    );
    this.router.delete(
      '/gig/:gigId/:sellerId',
      authMiddleware.checkAuthentication,
